...
<!-- npm badge -->
[![npm version][prism-npm-badge-svg]][prism-npm-badge]

<!-- GitHub badges -->
[![GitHub issues][prism-badge-issues]][prism-issues]
[![GitHub forks][prism-badge-forks]][prism-forks]
[![GitHub stars][prism-badge-stars]][prism-stars]
[![GitHub license][prism-badge-license]][prism-license]
...
Copy this package to the `packages/prism` folder of the [skeleton workspace][skeleton] then run the commands below.
...
The documentation is in construction and it's available at [https://angular-package.dev/prism](https://angular-package.dev/prism/)

<br>

## Changelog

To read it, click on the [CHANGELOG.md][prism-github-changelog] link.
...
MIT © angular-package ([license][prism-license])
...
<!-- This package: prism  -->
  <!-- GitHub: badges -->
  [prism-badge-issues]: https://img.shields.io/github/issues/angular-package/prism
  [prism-badge-forks]: https://img.shields.io/github/forks/angular-package/prism
  [prism-badge-stars]: https://img.shields.io/github/stars/angular-package/prism
  [prism-badge-license]: https://img.shields.io/github/license/angular-package/prism
  <!-- GitHub: badges links -->
  [prism-issues]: https://github.com/angular-package/prism/issues
  [prism-forks]: https://github.com/angular-package/prism/network
  [prism-license]: https://github.com/angular-package/prism/blob/master/LICENSE
  [prism-stars]: https://github.com/angular-package/prism/stargazers
<!-- This package -->
  [prism-github-changelog]: https://github.com/angular-package/prism/blob/main/CHANGELOG.md
